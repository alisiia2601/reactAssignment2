...
`;
  ...
  const dateSentAsArgument = dateStringSentAsArgument
    ? parse(dateStringSentAsArgument, 'yyyy-MM-dd', new Date())
    : null;
...
<html lang="en">
  ...
  <body>
    ...
    <main>
      ...
      <div class='container'>
        <p>The JS Framework course started ${formatDistanceToNow(
          startOfCourse
        )} ago</p>
      </div>
